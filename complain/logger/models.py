...
class Complaint(models.Model):
    ...
    screen_shot = models.ImageField(upload_to='static/%Y/%m/%d', max_length=2**20,blank=True, null=True) 
    original_document = models.FileField(upload_to='static/%Y/%m/%d', max_length=2**40,blank=True,null=True)
